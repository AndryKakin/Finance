...
copy "../contract/ProductContract.pb.go" "../Server/services/ProductContract.pb.go"
...
copy "../contract/ProductContract.pb.go" "../Server/services/PriceContract.pb.go"
...
copy "../contract/ProductContract.pb.go" "../Server/services/PurchaseContract.pb.go"
...
copy "../contract/ProductContract.pb.go" "../Server/services/CurrencyContract.pb.go"
